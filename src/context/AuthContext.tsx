  ...
  async function signIn(data) {
    const result = loginService.Login(data)
      .then(response => {
        ...
        Cookies.set('expirationJwtApplicationToken', response.data.data.expirationTimeAccessToken, { expires: 0.1 })

        Cookies.set('expirationDateTimeJwtApplicationToken', response.data.data.expirationDateTimeAccessToken, { expires: 0.1 })
